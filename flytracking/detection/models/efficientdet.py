...
from flytracking.detection.models.efficientnet import EfficientNet as EffNet
from flytracking.detection.utils.efficientnet import (
    Swish,
...
def nms(dets, thresh):
    return torchvision.ops.boxes.nms(dets[:, :4], dets[:, 4], thresh)
